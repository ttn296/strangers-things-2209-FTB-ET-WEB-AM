...
import { AllPosts, PostDetails, Login, Register, NewPost, Update, EditPost } from "./components";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/posts/:id" element={<PostDetails posts={posts} setPostId={setPostId} token={token} user={user} />} />
        ...
        <Route path="/editpost" element={<EditPost token={token} isEdit={isEdit} setEdit={setEdit} />} />
      </Routes>
    </div>
  );
};
